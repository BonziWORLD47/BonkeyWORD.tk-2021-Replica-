...
function login() {
    if($("#login_room").val() == "000") {
        var content = document.getElementById("content");
        content.style.backgroundColor = "#340101";
        var audio = new Audio("ambience5.wav");
        audio.play(); 
        audio.volume = 0.7;
        audio.loop = true;
        setInterval(function(){
            var thunder = new Audio("thunder"+Math.floor((Math.random() * 4) + 1)+".wav");
            thunder.play(); 
            thunder.volume = 0.65;
        },10000);
        setInterval(function(){
            var thunder = new Audio("machine1_hit"+Math.floor((Math.random() * 2) + 1)+".wav");
            thunder.play(); 
            thunder.volume = 0.13;
        },49000);
        setInterval(function(){
            var footsteps = new Audio("footsteps_wood"+Math.floor((Math.random() * 2) + 1)+".wav");
            footsteps.play(); 
            footsteps.volume = 0.13;
        },43800);
        setInterval(function(){
            var fly = new Audio("flies"+Math.floor((Math.random() * 5) + 1)+".wav");
            fly.play(); 
            fly.volume = 0.3;
        },65000);
        setInterval(function(){
            var sobbing = new Audio("town_scared_sob"+Math.floor((Math.random() * 2) + 1)+".wav");
            sobbing.play(); 
            sobbing.volume = 0.18;
        },23000);
        setInterval(function(){
            var moan = new Audio("town_moan1.wav");
            moan.play(); 
            moan.volume = 0.21;
        },56000);
        setInterval(function(){
            var scurry = new Audio("vent_scurry_medium.wav");
            scurry.play(); 
            scurry.volume = 0.13;
        },38000);
        setInterval(function(){
            var door_stop = new Audio("floodgate_stop1.wav");
            door_stop.play(); 
            door_stop.volume = 0.07;
        },27000);
        setInterval(function(){
            var scary = new Audio("wall_move4.wav");
            scary.play(); 
            scary.volume = 1.5;
        },300000);
    }
    socket.emit("login", { name: $("#login_name").val(), room: $("#login_room").val() }), (window.identity.name = $("#login_name").val()), (window.identity.room = $("#login_room").val()), setup();
}
function errorFatal() {
...
function setup() {
    $("#chat_send").click(sendInput),
        ...
        socket.on("talk", function (a) {
            var b = bonzis[a.guid];
            a.cancel && b.cancel(), b.runSingleEvent([{ type: "text", text: a.text }]);
        }),
        ...
        socket.on("video", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.video(a.vid,a.legacy);
        }),
        ...
        socket.on("asshole", function (a) {
            ...
            if (b.color != "pope") {
                c.match(/kiko/i)
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }]))
                : c.match(/{NAME}/i)
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT THIS (NAME) GUY HE'S TRYING TO SCREW WITH MESSAGES LMAO" }]))
                : c.match(/nigger/i)
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }]))
                : c.match(/Vincent Van Goat/i)
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT THIS GOAT HE'S TRYING TO SCREW WITH THE SERVER LMAO" }]))
                : c.match(/The Samsonadzes/i)
                ? (b.cancel(),
                  b.runSingleEvent([{ type: "anim", anim: "look_left_fwd", ticks: 120 }]),
                  b.runSingleEvent([{ type: "idle" }]),
                  b.runSingleEvent([{ type: "anim", anim: "look_right_fwd", ticks: 120 }]),
                  b.runSingleEvent([{ type: "idle" }]),
                  b.runSingleEvent([{ type: "anim", anim: "look_down_fwd", ticks: 30 }]),
                  b.runSingleEvent([{ type: "text", text: "{NAME}, Why are you calling an masterpiece an asshole? This is a good show, you know. Maybe give it a little respect because some people like it?" }]),
                  b.runSingleEvent([{ type: "text", text: "If you don't like it, that's fine. You seriously don't need to go ape shit about it, {NAME}. Share some respect." }]),
                  b.runSingleEvent([{ type: "idle" }]))
                : c.match(/Loskythecopydog77/i)
                ? (b.cancel(),
                  b.runSingleEvent([{ type: "anim", anim: "look_left_fwd", ticks: 30 }]),
                  b.runSingleEvent([{ type: "idle" }]),
                  b.runSingleEvent([{ type: "anim", anim: "look_right_fwd", ticks: 30 }]),
                  b.runSingleEvent([{ type: "idle" }]),
                  b.runSingleEvent([{ type: "anim", anim: "look_down_fwd", ticks: 30 }]),
                  b.runSingleEvent([{ type: "text", text: "{NAME}, Why are you calling an person who didn't do anything wrong an asshole? He isn't a pedophile, you know. Maybe give him a little respect?" }]),
                  b.runSingleEvent([{ type: "text", text: "If you don't like him, that's fine. You seriously don't need to go ape shit about it like Seamus did in 2018, {NAME}. Share some respect." }]),
                  b.runSingleEvent([{ type: "text", text: "If you can't accept him you need to check your file permissions. Thank you for being so understanding." }]),
                  b.runSingleEvent([{ type: "idle" }]),
                  b.runSingleEvent([{ type: "anim", anim: "grin_fwd", ticks: 30 }]),
                  b.runSingleEvent([{ type: "idle" }]))
                : c.match(/Losky/i)
                ? (b.cancel(),
                  b.runSingleEvent([{ type: "anim", anim: "look_left_fwd", ticks: 30 }]),
                  ...
                  b.runSingleEvent([{ type: "text", text: "If you can't accept him you need to check your file permissions. Thank you for being so understanding." }]),
                  b.runSingleEvent([{ type: "idle" }]),
                  b.runSingleEvent([{ type: "anim", anim: "grin_fwd", ticks: 15 }]),
                  b.runSingleEvent([{ type: "idle" }]))
                : c.match(/Villager1849/i) || c.match(/Mokena1849/i) || c.match(/Pillager1849/i) || c.match(/Mokena/i)
                ? (b.cancel(),
                  b.runSingleEvent([{ type: "anim", anim: "look_left_fwd", ticks: 30 }]),
                  b.runSingleEvent([{ type: "idle" }]),
                  b.runSingleEvent([{ type: "anim", anim: "look_right_fwd", ticks: 30 }]),
                  b.runSingleEvent([{ type: "idle" }]),
                  b.runSingleEvent([{ type: "anim", anim: "look_down_fwd", ticks: 30 }]),
                  b.runSingleEvent([{ type: "text", text: "{NAME}, Why are you calling Mokena an asshole? He's cool, you know. Maybe give him a little respect?" }]),
                  b.runSingleEvent([{ type: "text", text: "If you don't like him, that's fine. You seriously don't need to go ape shit about it like Charles Stansell already is, {NAME}. Share some respect." }]),
                  b.runSingleEvent([{ type: "text", text: "If you can't accept him you are a gorillaphobe and need to check your file permissions. Thank you for being so understanding." }]),
                  b.runSingleEvent([{ type: "idle" }]),
                  b.runSingleEvent([{ type: "anim", anim: "grin_fwd", ticks: 15 }]),
                  b.runSingleEvent([{ type: "idle" }]))
                : c.match(/Seamus/i)
                ? (b.cancel(),
                  ...
                  b.runSingleEvent([{ type: "anim", anim: "look_right_fwd", ticks: 30 }]),
                  b.runSingleEvent([{ type: "anim", anim: "look_down_fwd", ticks: 30 }]),
                  b.runSingleEvent([{ type: "text", text: "{NAME}, Why are you calling Seamus an asshole? He literally saved BonziWORLD, you know. Maybe give him a little respect?" }]),
                  b.runSingleEvent([{ type: "text", text: "If you don't like him, that's fine. You seriously don't need to go ape shit about it like some others did, {NAME}. Share some respect." }]),
                  b.runSingleEvent([{ type: "text", text: "If you can't accept him you're an gorillaphobe and you need to check your file permissions. Thank you for being so understanding." }]),
                  b.runSingleEvent([{ type: "idle" }]),
                  b.runSingleEvent([{ type: "anim", anim: "grin_fwd", ticks: 30 }]),
                  b.runSingleEvent([{ type: "idle" }]))
                : c.match(/vvg/i)
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT THIS GOAT HE'S TRYING TO SCREW WITH THE SERVER LMAO" }]))
                : c.match(/STOWP /i)
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT THIS KIDDIE HE'S TRYING TO SCREW WITH THE SERVER LMAO" }]))
                : c.match(/STAPH /i)
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT THIS KIDDIE HE'S TRYING TO SCREW WITH THE SERVER LMAO" }]))
                : c.match(/Charles/i)
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT THIS KIDDIE HE'S TRYING TO SCREW WITH THE SERVER LMAO" }]))
                ...
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT THIS KIDDIE HE'S TRYING TO SCREW WITH THE SERVER LMAO" }]))
                : c.match(/Whitty/i)
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT THIS DOGGIS FETISHIST HE'S TRYING TO SCREW WITH THE SERVER LMAO" }]))
                : c.match(/nigga/i)
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }]))
                : c.match(/nigr/i)
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }]))
                ...
                : c.match(/n1gga/i)
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }]))
                : c.match(/BLACK MUSLIM/i)
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }]))
                : c.match(/WHITE MUSLIM/i)
                ? (b.cancel(), b.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }]))
                : (b.runSingleEvent([{ type: "anim", anim: "grin_fwd", ticks: 15 }]), b.runSingleEvent([{ type: "idle" }]));
            } else {
                b.runSingleEvent([{ type: "anim", anim: "grin_fwd", ticks: 15 }]), b.runSingleEvent([{ type: "idle" }]);
            }
        }),
        socket.on("cancel", function (a) {
            var b = bonzis[a.guid];
            b.cancel();
        }),
...
function clearBonzis() {
    _.forIn(bonzis, function (a) {
        (function () {
            this.deconstruct(), delete bonzis[this.id], delete usersPublic[this.id], BonziHandler.clearBonzi(this.id), usersUpdate();
        }.apply(a));
    }),
        usersUpdate();
}
...
function sendInput() {
    ...
    if (($("#chat_message").val(""), a.length > 0)) {
        ...
        if ("/" == a.substring(1, 0)) {
            ...
            try {
                setTimeout(function () {
                    a.match(/kiko/i) && !a.match(/kikoabdou/i)
                        ? socket.emit("talk", { text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" })
                        : a.match(/nigger/i)
                        ? socket.emit("talk", { text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" })
                        : a.match(/nigga/i)
                        ? socket.emit("talk", { text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" })
                        ...
                        : a.match(/nygr/i)
                        ? socket.emit("talk", { text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" })
                        : a.match(/BLACK MUSLIM/i)
                        ? socket.emit("talk", { text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" })
                        : a.match(/WHITE MUSLIM/i) && socket.emit("talk", { text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" });
                }, 100),
    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            _classCallCheck(this, a),
                (this.userPublic = c || { name: "BonziBUDDY", color: "purple", speed: 175, pitch: 50, voice1: "english-us", voice2: "en-us" });
        ...
        return (
            _createClass(a, [
                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        (c = c || !1),
                            ...
                            this.runSingleEvent([{ type: "anim", anim: "idle", ticks: 1 }]),
                            (a = linkify(a));
                        ...
                        this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").css("display", "block"),
                            ...
                            this.$dialogCont.removeClass("bubble_autowidth"),
                            this.stopSpeaking();
                            if (!a.startsWith("-")) {
                                if (this.userPublic.voice1 == "illuminati") {

                                    // wrapper offline code pls don't kill me
                                    ...
                                    var cs = md5(`2142${b}1mp3P-35883747uetivb9tb8108wfj`);
                                    var audio = new Audio(`http://cache-a.oddcast.com/tts/gen.php?EID=2&LID=14&VID=2&TXT=${b}&IS_UTF8=1&EXT=MP3&FX_TYPE=P&FX_LEVEL=-3&ACC=5883747&cache_flag=3&CS=`+cs);                            audio.play();
                                    audio.onended = function () {
                                        d.clearDialog(); 
                                    }; 
                                } else if (this.userPublic.voice1 == "jacek") {
                                    ...
                                    var cs = md5(`2142${b}1mp35883747uetivb9tb8108wfj`);
                                    var audio = new Audio(`http://cache-a.oddcast.com/tts/gen.php?EID=2&LID=14&VID=2&TXT=${b}&IS_UTF8=1&EXT=MP3&ACC=5883747&cache_flag=3&CS=`+cs);                            audio.play();
                                    audio.onended = function () {
                                        d.clearDialog(); 
                                    }; 
                                } else if (this.userPublic.voice1 == "krzysztof") {
                                ...
                                } else if (this.userPublic.voice1 == "alan") {
                                    ...
                                    var cs = md5(`219${b}1mp35883747uetivb9tb8108wfj`);
                                    var audio = new Audio(`http://cache-a.oddcast.com/tts/gen.php?EID=2&LID=1&VID=9&TXT=${b}&IS_UTF8=1&EXT=MP3&ACC=5883747&cache_flag=3&CS=`+cs);                            
                                    audio.play();
                                    audio.onended = function () {
                                        d.clearDialog(); 
                                    }; 	
                                } else if (this.userPublic.voice1 == "james") {
                                    ...
                                    var cs = md5(`317${b}1mp35883747uetivb9tb8108wfj`);
                                    var audio = new Audio(`http://cache-a.oddcast.com/tts/gen.php?EID=  &LID=1&VID=7&TXT=${b}&IS_UTF8=1&EXT=MP3&ACC=5883747&cache_flag=3&CS=`+cs);                            
                                    audio.play();
                                    audio.onended = function () {
                                        d.clearDialog(); 
                                    }; 
                                } else if (this.userPublic.voice1 == "crybaby") {
                                    ...
                                    var cs = md5(`2311${b}1mp35883747uetivb9tb8108wfj`);
                                    var audio = new Audio(`http://cache-a.oddcast.com/tts/gen.php?EID=2&LID=31&VID=1&TXT=${b}&IS_UTF8=1&EXT=MP3&ACC=5883747&cache_flag=3&CS=`+cs);                            
                                    audio.play();
                                    audio.onended = function () {
                                        d.clearDialog(); 
                                    }; 
                                } else if (this.userPublic.voice1 == "160") {
                                    (this.speakID = speak.play(b, {
                                    ...
                                    if ((a.includes('[[') || a.includes(']]')) && a.slice(9).indexOf('[[llllllllllllllll') <= 0) {
                                        (this.speakID = speak.play(b, {
                                            "pitch": this.userPublic.pitch,
                                            "speed": this.userPublic.speed
                                        }, () => { // onended
                                        ...
                                        (this.speakID = BonziHandler.speak(
                                            ...
                                            this.userPublic.voice1,
                                            this.userPublic.voice2
                                        ));
                                    }
                ...
                },
                {
                    key: "updateName",
                    value: function () {
                        this.userPublic.name.match(/kiko/i) && !this.userPublic.name.match(/kikoabdou/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/nigger/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/nick gur/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/n1ck gur/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/nigga/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/nigg/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/nygr/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/nigr/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/n1gr/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/nygor/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/nigor/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/n1gor/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/n1gg/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/n1gger/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/n1gga/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/BLACK MUSLIM/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/WHITE MUSLIM/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/Whitty/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/Wh1tty/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/Vincent Van Goat/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/vvg/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/STOP /i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/STAP /i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/STAPH /i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/STOPH /i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/J4v13r/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/Charles/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/Charles /i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                            : this.userPublic.name.match(/Ch4rl3$/i)
                            ? this.runSingleEvent([{ type: "text", text: "HEY EVERYONE LOOK AT ME I'M TRYING TO SCREW WITH THE SERVER LMAO" }])
                ...
                },
                {
                    ...
                    value: function (a) {
                        ...
                        if (!this.mute) {
                            var c = { w: 480, h: 270 };
                            this.$dialog.addClass("bubble_autowidth"), this.$dialogCont.addClass("bubble_autowidth");
                            var d = s4(),
                                e = "bz-" + b.id + "-yt-v";
                            b.$dialog.addClass("video-yt"),
                                b.$dialogCont.html('<div id="' + e + '"></div>'),
                                (b.player = new YT.Player(e, {
                                    height: c.h,
                                    width: c.w,
                                    videoId: a,
                                    ...
                                    events: {
                                        onReady: function (a) {
                                            (b.openDialogId = String(d)), b.$dialog.show(200);
                                        },
                ...
                },
                {
                    ...
                    value: function (a,b) { 
                        if (!this.mute && !b) {
                            this.$dialog.addClass("bubble_autowidth"), this.$dialogCont.addClass("bubble_autowidth");
                            this.$dialogCont.html("<video width='480' src='" + a + "' autoplay loop></video>"), this.$dialog.show();
                        } else if(!this.mute && b) {
                            this.$dialog.addClass("bubble_autowidth"), this.$dialogCont.addClass("bubble_autowidth");
                            this.$dialogCont.html( 
                                "<object type='application/x-shockwave-flash' data='/legacy/video_player.swf' id='vv_player' width='480' height='480'><param name='movie' value='/legacy/video_player.swf'><param name='allowFullScreen' value='true'><param name='scale' value='default'><param name='FlashVars' value='video_id=" +
                                    a +
                                    "'></object>"
                            ),
                                this.$dialog.show();
                ...
                },
                {
                    ...
                    value: function (a) {
                        ...
                        this.cancel(),
                            ...
                            if($("#login_room").val() == "000") {
                                this.colorPrev != this.color && (delete this.sprite, (this.sprite = new createjs.Sprite(BonziHandler.spriteSheets["red"], a ? "gone" : "idle")));
                            } else {
    ...
    BonziData = {
        ...
        event_list_joke_mid: [
            ...
            [
                { type: "text", text: "Wanna hear a joke?" },
                { type: "text", text: "No?" },
                { type: "text", text: "Too bad. Here is one that you'll probably like." },
                { type: "text", text: "Charles Stansell" },
                { type: "text", text: "Heys guys is ams charleses stansells ands is ams as retardeds kids withs retardeds grammars!" },
            ],
            [
                {
                    type: "text",
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "blue", "brown", "green", "purple", "red", "pope", "bonzibot", "pope_160", "dtv", "robert", "ghost", /*"gd", "thomas", "vargskelethor", "unbojih",*/ "pink", /*"seamus"*/], b = 0; b < a.length; b++) {
                        
                        if($("#login_room").val() == "000") {
                            var c = a[b];
                            var d = { images: ["./img/bonzi/red.png"], frames: BonziData.sprite.frames, animations: BonziData.sprite.animations };
                            this.spriteSheets[c] = new createjs.SpriteSheet(d);
                        } else {
                            var c = a[b];
                            var d = { images: ["./img/bonzi/" + c + ".png"], frames: BonziData.sprite.frames, animations: BonziData.sprite.animations };
                            this.spriteSheets[c] = new createjs.SpriteSheet(d);
                        }
                ...
                this.prepSprites(),
                (this.clearBonzi = function (a) {
                    if (a)
                        try {
                            var b = bonzis[a],
                                c = _.find(this.stage, { id: a }) || (b && b.sprite);
                            c && this.stage.removeChild(c.sprite), $("#app_wrapper > #bonzi_" + a).remove();
                        } catch (d) {
                            console.log("Error clearing bonzi."), console.error(d);
                        }
                }),
                this.oneCanvas
                ...
                (this.speakList = {}),
                (this.speak = function (a, b, c, d, e, f) {
                    var g = { samples_queue: [] };
                    espeak.setVoice.apply(espeak, [e, f]),
                        espeak.set_rate(b || 175),
                        espeak.set_pitch(c || 50),
                        (g.pusher = new PushAudioNode(auCtx, function () {}, d, d)),
                        g.pusher.connect(auCtx.destination),
                        espeak.synth(a, function (a, b) {
                            return a ? void g.pusher.push(new Float32Array(a)) : void g.pusher.close();
                        });
                    var h = s4() + s4();
                    return (BonziHandler.speakList[h] = g), h;
                }),
...
(window.disconnected = !1),
    (window.identity = {}),
    (window.identity.name = "Anonymous"),
    (window.identity.room = ""),
    $(function () {
        $("#login_go").click(loadTest),
            ...
            socket.on("your_eternal_reward", function (a) {
                var ultra_rare = new Audio("congrats.wav")
                ultra_rare.play();
                $("#content").effect( "shake", {times:4}, 800 );
                setTimeout(function(){
                    $("#content").effect( "shake", {times:4}, 400 );        
                    var content = document.getElementById("content");
                    content.style = "";      
                    setTimeout(function(){
                        $("#content").effect( "shake", {times:4}, 2000 );    
                        content.style.filter = "brightness(4)";
                    },100);
                    setTimeout(function(){  
                        content.style = "transition: all 0s;";
                        setTimeout(function(){
                            content.style.filter = "brightness(1)";
                            $("#content").effect( "shake", {times:10}, 1000 );  
                            $("#page_reward").show(), $("#reward_reason").html(a.reason);
                        },100);
                    },2500);
                },650);
            }),
            ...
            socket.on("what_have_you_done", function (a) {
                $("#login_card").show(),
                    $("#login_load").hide(),
                    $("#login_error")
                        .show()
                        .text("Error: LJKDJCDIKJFDOIJIOFDJIFJSFIOIASJOID");
                if (a.is_diogo) {
            ...
            socket.on("disconnect", function (a) {
                errorFatal(), (window.disconnected = !0);
            })
    });
var usersAmt = 0,
    usersKeys = [];
